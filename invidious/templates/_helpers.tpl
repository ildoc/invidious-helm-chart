...
{{- define "invidious.init-defaults" -}}
    ...
    {{- if .Values.companion.enabled }}
        ...
        {{- if and (not .Values.existingSecret) (not .Values.secrets.companionKey) (not .Values.config.invidious_companion_key) }}
    ...
    {{- if and (not .Values.existingSecret) (not .Values.secrets.hmacKey) (not .Values.config.hmac_key) }}
